"""
Django settings for demoapp_41824 project.
...
ROOT_URLCONF = 'demoapp_41824.urls'
...
WSGI_APPLICATION = 'demoapp_41824.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp_41824 API",
    "DESCRIPTION": "API documentation for demoapp_41824 App",
    "VERSION": "v1",
}
